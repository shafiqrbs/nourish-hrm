 ...
 */
@Entity
@Table( name = "InsuranceNominee" )
public class InsuranceNominee extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "EmployeeCode", columnDefinition="VARCHAR(20)", foreignKey = @ForeignKey(name = "FK_InsuranceNominee_EmployeeInfo"), nullable = false)
