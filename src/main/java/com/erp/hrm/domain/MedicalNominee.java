 ...
 */
@Entity
@Table( name = "MedicalNominee" )
public class MedicalNominee extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "EmployeeCode", columnDefinition="VARCHAR(20)", foreignKey = @ForeignKey(name = "FK_MedicalNominee_EmployeeInfo"), nullable = false)
