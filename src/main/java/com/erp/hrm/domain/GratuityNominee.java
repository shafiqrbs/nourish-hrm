 ...
 */
@Entity
@Table( name = "GratuityNominee" )
public class GratuityNominee extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "EmployeeCode", columnDefinition="VARCHAR(20)", foreignKey = @ForeignKey(name = "FK_GratuityNominee_EmployeeInfo"), nullable = false)
