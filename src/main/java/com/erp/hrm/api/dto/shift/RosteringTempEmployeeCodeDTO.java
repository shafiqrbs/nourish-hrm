 ...
 * Created by Sohag
 */
public class RosteringTempEmployeeCodeDTO {
    ...
    public RosteringTempEmployeeCodeDTO() {
    }

    public RosteringTempEmployeeCodeDTO(String userId, String ruleName, String ruleCode, String selectedEmployeeCodes, String unitName, String departmentName, String designationName, String staffCategoryName, boolean isUsingFilter) {
        this.userId = userId;
