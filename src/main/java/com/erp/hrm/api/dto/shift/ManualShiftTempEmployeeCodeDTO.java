 ...
 * Created by Sohag
 */
public class ManualShiftTempEmployeeCodeDTO {
    ...
    public ManualShiftTempEmployeeCodeDTO() {
    }

    public ManualShiftTempEmployeeCodeDTO(String userId, String ruleName, String ruleCode, String selectedEmployeeCodes, String unitName, String departmentName, String designationName, String staffCategoryName, boolean isUsingFilter) {
        this.userId = userId;
